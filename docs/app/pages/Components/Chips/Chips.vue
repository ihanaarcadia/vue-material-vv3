...
<template>
  ...
  >
    ...
    <div class="page-container-section">
      ...
      <code-example
        title="Single"
        :component="examples['single-chip']"
      />
      ...
      <api-item title="API - md-chip">
        ...
        <api-table
          #props
          :headings="chip.props.headings"
          :props="chip.props.props"
        />
        <api-table
          #events
          :headings="chip.events.headings"
          :props="chip.events.props"
        />
      </api-item>
    </div>

    <div class="page-container-section">
      <h2 id="editable-model">
        Editable model
      </h2>
    ...
    <div class="page-container-section">
      ...
      <code-example
        title="Scoped Slot"
        :component="examples['chip-custom-template']"
      />
    </div>

    <div class="page-container-section">
      <h2 id="duplicated-chip">
        Duplicated Chip
      </h2>

      <p>Chips would reject insertion if a chip is duplicated. You can customize feedback style of the duplicated chip:</p>
      <code-example
        title="Duplicated Feedback"
        :component="examples['duplicated-feedback']"
      />
    </div>
    ...
    <div class="page-container-section">
      ...
      <code-example
        title="Auto insert"
        :component="examples['auto-insert']"
      />
    </div>
    ...
    <div class="page-container-section">
      ...
      <api-item title="API - md-chips">
        ...
        <api-table
          #props
          :headings="chips.props.headings"
          :props="chips.props.props"
        />
        <api-table
          #events
          :headings="chips.events.headings"
          :props="chips.events.props"
        />
      </api-item>
    </div>
  </page-container>
