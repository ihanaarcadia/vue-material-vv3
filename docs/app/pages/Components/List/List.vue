...
<template>
  ...
  >
    ...
    <div class="page-container-section">
      ...
      <code-example
        title="Single Line"
        :component="examples['single-line']"
      />
    </div>
    ...
    <div class="page-container-section">
      ...
      <code-example
        title="Double Line"
        :component="examples['double-line']"
      />
    </div>
    ...
    <div class="page-container-section">
      ...
      <code-example
        title="Triple Line"
        :component="examples['triple-line']"
      />
    </div>
    ...
    <div class="page-container-section">
      ...
      <ul>
        <li
          v-for="event in interactionEvents"
          :key="event"
        >
          {{ event }}
        </li>
      ...
      <p>
        All <a
          ...
          target="_blank"
        >options</a> of <code>router-link</code> can be simply used here. This will render an <code>a</code> tag:
      </p>
      <code-example
        title="Different types"
        :component="examples['list-types']"
      />
    </div>
    ...
    <div class="page-container-section">
      ...
      <code-example
        title="Expansion"
        :component="examples['list-expansion']"
      />
      ...
      <api-item title="API - md-list">
        ...
        <api-table
          #props
          :headings="list.props.headings"
          :props="list.props.props"
        />
        <api-table
          #classes
          :headings="list.classes.headings"
          :props="list.classes.props"
        />
      </api-item>

      <api-item title="API - md-list-item">
        <p>
          The following options can be applied to any list item. All <a
            href="https://router.vuejs.org/en/api/router-link.html"
            target="_blank"
