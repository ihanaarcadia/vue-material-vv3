...
<template>
  ...
  >
    ...
    <div class="page-container-section">
      ...
      <code-example
        title="Start and End"
        :component="examples['directions']"
      />
    </div>

    <div class="page-container-section">
      <h2 id="menu-alignments">
        Alignments
      </h2>
      ...
      <code-example
        title="Trigger alignment and Offsets"
        :component="examples['menu-alignments']"
      />
    </div>
    ...
    <div class="page-container-section">
      ...
      <code-example
        title="5 possible sizes"
        :component="examples['sizes']"
      />
      <note-block>The max-width of a menu is 280px.</note-block>
    </div>

    <div class="page-container-section">
      <h2 id="menu-autoclose">
        AutoClose
      </h2>

      <p><code>md-menu</code> can be auto closed on click or select:</p>
      <code-example
        title="Auto close menu on events"
        :component="examples['auto-close']"
      />
    </div>
    ...
    <div class="page-container-section">
      ...
      <code-example
        title="Open a menu programatically"
        :component="examples['multiple-content']"
      />
      <note-block tip>
        A <code>md-menu</code> with items that have icons aligns perfectly with <code>md-icon-button</code>.
      </note-block>
