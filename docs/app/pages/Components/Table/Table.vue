...
<template>
  ...
  >
    <div class="page-container-section">
      ...
      <note-block warning>
        This component is still WIP. Right now you can use the core basic stuff, but soon we will release <strong>Pagination</strong>, <strong>Internal search</strong> and <strong>Edit options</strong>. The current API will not change during the beta phase (likely).
      </note-block>
    </div>
    ...
    <div class="page-container-section">
      ...
      <code-example
        title="Table within a card"
        :component="examples['table-card']"
      />
    </div>

    <div class="page-container-section">
      <h2 id="advanced-table">
        Advanced tables
      </h2>
      ...
      <note-block alert>
        This section will assume that you have knowledge of <a
          ...
          target="_blank"
        >Vue Scoped Slots</a>. You'll need them to create advanced tables.
      </note-block>
      ...
      <code-example
        ...
        :component="examples['table-template']"
      />
    </div>
    ...
    <div class="page-container-section">
      ...
      <code-example
        ...
        :component="examples['table-custom-sort']"
      />
    </div>
    ...
    <div class="page-container-section">
      ...
      <code-example
        title="Fixed headers"
        :component="examples['table-fixed']"
      />
    </div>
    ...
    <div class="page-container-section">
      ...
      <code-example
        ...
        :component="examples['table-search']"
      />
    </div>
    ...
    <div class="page-container-section">
      ...
      <code-example
        title="Single"
        :component="examples['table-single']"
      />
    </div>
    ...
    <div class="page-container-section">
      ...
      <code-example
        title="Multiple"
        :component="examples['table-multiple']"
      />
    </div>
    ...
    <div class="page-container-section">
      ...
      <api-item title="API - md-table">
        ...
        <api-table
          #props
          :headings="table.props.headings"
          :props="table.props.props"
        />
        <api-table
          #events
          :headings="table.events.headings"
          :props="table.events.props"
        />
      </api-item>
      ...
      <api-item title="API - md-table-head &amp; md-table-cell">
        ...
        <api-table
          #props
          :headings="cell.props.headings"
          :props="cell.props.props"
        />
        <api-table
          #events
          :headings="cell.events.headings"
          :props="cell.events.props"
        />
      </api-item>
      ...
      <api-item title="API - md-table-pagination">
        ...
        <api-table
          #props
          :headings="pagination.props.headings"
          :props="pagination.props.props"
        />
      </api-item>
    </div>
  </page-container>
