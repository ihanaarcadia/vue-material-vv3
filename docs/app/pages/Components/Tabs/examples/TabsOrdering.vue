<template>
  <div>
    ...
    <md-button
      class="md-primary"
      @click="showMiddleTab = !showMiddleTab"
    >
      Toggle second tab (id="B")
    </md-button>
    <md-button
      class="md-primary"
      @click="showLastTab = !showLastTab"
    >
      Toggle last tab (id="Z")
    </md-button>
    <md-button
      class="md-primary"
      @click="dynamicId++"
