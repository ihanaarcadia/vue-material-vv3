      ...
      <div class="md-layout md-gutter md-alignment-top-left">
        <div class="md-layout-item md-xsmall-size-100">
          <md-card
            class="md-primary"
            md-with-hover
            @click="openLink('https://github.com/vuematerial/webpack')"
          >
            <md-ripple>
              <md-card-header>
                <md-card-header-text>
                ...
                <md-card-media>
                  <img
                    src="/assets/boilerplates/webpack.png"
                    alt="Webpack"
                  >
                </md-card-media>
              </md-card-header>
        ...
        <div class="md-layout-item md-xsmall-size-100">
          <md-card
            ...
            md-theme="nuxt"
            md-with-hover
            @click="openLink('https://github.com/vuematerial/nuxtjs')"
          >
            <md-ripple>
              <md-card-header>
                <md-card-header-text>
                ...
                <md-card-media>
                  <img
                    src="/assets/boilerplates/nuxt.png"
                    alt="Nuxt"
                  >
                </md-card-media>
              </md-card-header>
        ...
        <div class="md-layout-item md-xsmall-size-100">
          ...
          >
            <md-ripple>
              ...
              <div class="ecosystem-logo">
                <img
                  src="/assets/boilerplates/html5.png"
                  alt="HTML File"
                >
              </div>
            </md-ripple>
          ...
          <md-card
            md-with-hover
            class="flying"
            @click="openLink('https://codesandbox.io/s/github/vuematerial/examples/tree/master/examples/quick-start')"
          >
            <md-ripple>
              <md-card-header>
                <div class="md-title">
              ...
              <div class="ecosystem-logo">
                <img
                  src="/assets/boilerplates/codesandbox.png"
                  alt="Codepen"
                >
              </div>
            </md-ripple>
