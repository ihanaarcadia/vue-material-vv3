...
<template>
  ...
  >
    <div class="page-container-section">
      ...
      <note-block alert>
        The scrollbars <strong>only</strong> works on <code>html</code> tag and on Vue Material components, like <code>md-content</code> or <code>md-drawer</code>. Due to CSS limitations, the style will be applied only on Webkit/Blink browsers (Chrome, Safari and Opera).
      </note-block>
    </div>
    ...
    <div class="page-container-section">
      <code-example
        title="Scrollbar"
        :component="examples['scrollbar-example']"
      />
    </div>
  </page-container>
</template>
